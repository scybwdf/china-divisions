...
[![Build Status](https://travis-ci.org/felix/china-divisions.svg?branch=master)](https://travis-ci.org/felix/china-divisions)
[![Coverage Status](https://coveralls.io/repos/github/felix/china-divisions/badge.svg)](https://coveralls.io/github/felix/china-divisions)
[![StyleCI](https://github.styleci.io/repos/151451370/shield?branch=master)](https://github.styleci.io/repos/151451370)
[![Packagist](https://img.shields.io/packagist/v/felix/china-divisions.svg)](https://packagist.org/packages/felix/china-divisions)
...
```bash
composer require felix/china-divisions
```
